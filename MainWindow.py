...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.packet_view = QtWidgets.QTreeWidget(parent=self.centralwidget)
        self.packet_view.setMouseTracking(True)
        self.packet_view.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.packet_view.setAlternatingRowColors(True)
        self.packet_view.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self.packet_view.setUniformRowHeights(True)
        self.packet_view.setAllColumnsShowFocus(True)
        self.packet_view.setObjectName("packet_view")
        self.packet_view.header().setVisible(True)
        self.packet_view.header().setHighlightSections(True)
        self.packet_view.header().setMinimumSectionSize(100)
        self.gridLayout.addWidget(self.packet_view, 4, 0, 1, 1)
        self.hex_view = QtWidgets.QColumnView(parent=self.centralwidget)
        self.hex_view.setObjectName("hex_view")
        self.gridLayout.addWidget(self.hex_view, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.captured_view, 1, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.packet_view.headerItem().setText(0, _translate("MainWindow", "新建列"))
