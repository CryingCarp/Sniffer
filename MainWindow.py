...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.hex_browser, 5, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.captured_view, 2, 0, 1, 3)
        ...
        self.BPF = QtWidgets.QLabel(parent=self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.BPF.sizePolicy().hasHeightForWidth())
        self.BPF.setSizePolicy(sizePolicy)
        self.BPF.setMaximumSize(QtCore.QSize(80, 16777215))
        self.BPF.setObjectName("BPF")
        self.horizontalLayout.addWidget(self.BPF)
        self.filter = QtWidgets.QLineEdit(parent=self.centralwidget)
        ...
        self.filter.setMinimumSize(QtCore.QSize(300, 0))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.save_button.setText(_translate("MainWindow", "保存数据包"))
        self.BPF.setText(_translate("MainWindow", "BPF过滤器："))
